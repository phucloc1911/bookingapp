...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      await GoogleSignIn.instance.initialize(
        serverClientId: '975538261911-og3pl0lf91k7t8h6hrav4p77qvnfahhl.apps.googleusercontent.com', 
      );
      ...
      if (!context.mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Lỗi xác thực: ${e.message}")));
    } catch (e) {
      if (!context.mounted) return;
  ...
  Future<void> _loginWithEmail() async {
    ...
    try {
      ...
      Navigator.pop(context); // Trở về Home
    } on FirebaseAuthException catch (e) {
      if (!context.mounted) return;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text("Đăng nhập bằng Google", style: TextStyle(color: Colors.black87, fontSize: 16, fontWeight: FontWeight.w600)),
                ),
              ),
