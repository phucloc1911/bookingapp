  ...
  Future<void> _deleteSelectedRooms() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Đã xóa các mục được chọn khỏi danh sách yêu thích'),
        ),
      );
    }
  }
              ...
              children: [
                _buildFilterChip('Loại hình', _selectedType, () {
                  _showBottomSheetMenu(
                    'Chọn loại hình',
                    ['Tất cả', 'Khách sạn', 'Homestay', 'Resort', 'Biệt thự'],
                    _selectedType,
                    (value) {
                      setState(() {
                        _selectedType = value;
                ...
                _buildFilterChip('Xếp hạng', _selectedRating, () {
                  _showBottomSheetMenu(
                    'Chọn xếp hạng tối thiểu',
                    ['Tất cả', '5 Sao', '4.5+', '4.0+', '3.0+'],
                    _selectedRating,
                    (value) {
                      setState(() {
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(
                    child: Text('Không có mục yêu thích nào.'),
                  );
                }
                ...
                // LOGIC LỌC DỮ LIỆU TÍCH HỢP ĐỦ THEO SAO VÀ TỪ KHÓA
                var filteredRooms = rawData.where((data) {
                  ...
                  bool matchesType =
                      _selectedType == 'Tất cả' || type == _selectedType;
                ...
                if (_selectedSort == 'Giá thấp - cao') {
                  filteredRooms.sort(
                    (a, b) => (a['price'] ?? 0.0).compareTo(b['price'] ?? 0.0),
                  );
                ...
                // TRẢ VỀ GIAO DIỆN SAU KHI ĐÃ LỌC & SẮP XẾP
            ...
            Container(
              ...
              child: SafeArea(
                child: Row(
                  ...
                  children: [
                    Text(
                      'Đã chọn: ${_selectedIds.length} mục',
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              currentRoom.rating.toStringAsFixed(1),
                              style: const TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                              ),
